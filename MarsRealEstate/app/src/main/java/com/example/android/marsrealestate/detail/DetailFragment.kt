...
class DetailFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //15.5.2) In DetailFragment, in onCreateView() create a marsProperty variable from
        // the DetailFragmentArgs arguments, then use it to create a
        ...
        val viewModelFactory = DetailViewModelFactory(
            marsProperty, application)
        // 15.5.3) Use the factory to create a DetailViewModel and bind it to the viewModel:
