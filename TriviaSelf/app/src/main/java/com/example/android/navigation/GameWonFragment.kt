...
class GameWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        // Extracting Data from NavDirections:
        val args = GameWonFragmentArgs.fromBundle(requireArguments())
        // Toast the extracted Data:
        Toast.makeText(context, "Num Correct: ${args.numCorrect}, Num Questions: ${args.numQuestions}", Toast.LENGTH_LONG).show()
        // Adding options menu for Share icon:
        setHasOptionsMenu(true)
        return binding.root
    }

    // Creating an Intent to Share of type Action_Send
    ...
    // Starts an activity with the Intent generated by getShareIntent()
